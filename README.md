...
12/25 1차 완료했고, 조회수기능과 api호출상태관리 부분은 아직 좀 더 진행 예정입니다
### 📒 개요
...
### ⭐ 개발 과정에서 궁금했던 부분
       ...
       1.  현재 컴포넌트마다 각각 api 호출해서 하고 있는데 이렇게 하니까 코드량도 많고 아무래도 보기에 깔끔하지 않아서 전역 상태관리를 공부하고 적용해보고 싶은데 이부분에서 혹시 어떤 라이브러리가 적합한지 궁금합니다
